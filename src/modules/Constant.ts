...
// 30 had good output for witness
export const PUBLIC_POSTS = 30;

export const PUBLIC_THRESHOLD = 0.6;
export const PUBLIC_SIGMA = 0.15;
// Go back to 100 for full analysis
...
export const APPROACH = Approach.OPTIMISTIC;

export const OPTIMISTIC_SIGMA_RATING = 0.1;
export const CASE_SIGMA_RATING = 0.05;
